...
| Domain purity and import gate                              | Implemented and checked in CI                 | First Domain behavior       |
| Application port and transaction conventions               | Capture tested; command admission gaps closed | First use case              |
...
| Persistence, migrations, and projection restoration        | EventStore and snapshots implemented          | First durable record        |
| Backup, disaster recovery, and operational retention       | Deferred to deployment evidence               | First production deployment |
