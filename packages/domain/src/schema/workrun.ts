 ...
 *
 * The transition machine and takeover-exclusivity rules are a later change;
 * this file defines the data shape only.
 */
...
/**
 * Session-record shape is this change's implementation convention (the baseline
 * declares an array without fixing the inner shape); the executor is named
